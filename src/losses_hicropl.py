...
def loss_fn_hicropl(args, features):
    ...
    L4: InfoNCE(sketch/photo adapted prompted feature, positive sketch/photo augmentation feature)
    """
    (
    ...
    # --- L4: InfoNCE(base adapted prompted feature, positive augmentation feature) ---
