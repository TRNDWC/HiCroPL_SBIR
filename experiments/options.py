...
parser.add_argument('--triplet_margin', type=float, default=0.3, help='Margin for triplet loss (CLIP-AT: 0.3)')
parser.add_argument('--temperature', type=float, default=0.07, help='Temperature for classification softmax')
parser.add_argument('--lambda_cross_modal', type=float, default=1.0, help='Weight for sketch-photo alignment loss (NT-Xent or triplet)')
parser.add_argument('--cross_modal_loss', type=str, default='infonce', choices=['infonce', 'triplet'], help="Sketch-photo alignment: 'infonce' (symmetric NT-Xent, in-batch negatives) or 'triplet' (cosine-distance)")
