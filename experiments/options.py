...
parser.add_argument('--lambda_mcc_sk', type=float, default=0.1, help='Weight for L6: MCC Loss (sketch intra-modal)')
parser.add_argument('--lambda_mcc_ph', type=float, default=0.1, help='Weight for L6: MCC Loss (photo intra-modal)')
