...
parser.add_argument('--lambda_struct', type=float, default=0.1, help='Default weight for modality-specific structural alignment losses')
parser.add_argument('--lambda_struct_photo', type=float, default=None, help='Optional override for photo structural loss weight; defaults to lambda_struct')
parser.add_argument('--lambda_struct_sketch', type=float, default=None, help='Optional override for sketch structural loss weight; defaults to lambda_struct')
