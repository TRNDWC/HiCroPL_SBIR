...
parser.add_argument('--cross_modal_loss', type=str, default='infonce', choices=['infonce', 'triplet'], help='Sketch-photo alignment: InfoNCE (in-batch negatives) or cosine-distance triplet')
