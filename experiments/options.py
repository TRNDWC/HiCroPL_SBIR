...
parser.add_argument('--lambda_struct_photo', type=float, default=0.1, help='Weight for structural alignment loss on Photo branch')
parser.add_argument('--lambda_struct_sketch', type=float, default=0.1, help='Weight for structural alignment loss on Sketch branch')
