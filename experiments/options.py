...
parser.add_argument('--accumulate_grad_batches', type=int, default=1, help='Accumulate gradients to emulate a larger global batch with smaller per-GPU batches')
