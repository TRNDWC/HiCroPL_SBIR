...
parser.add_argument('--lambda_cross_modal', type=float, default=1.0, help='Weight for sketch-photo triplet loss (CLIP-AT Eq. 3)')
parser.add_argument('--lambda_ce', type=float, default=0.5, help='Weight for visual-text classification loss (CLIP-AT lambda_1, paper default 0.5)')
parser.add_argument('--triplet_margin', type=float, default=0.3, help='Margin for cosine-distance triplet loss (CLIP-AT mu, paper default 0.3)')
