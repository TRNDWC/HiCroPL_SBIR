...
parser.add_argument('--ctx_init', type=str, default='a photo or a sketch of a', help='Initial text context (shared for both photo and sketch)')
...
parser.add_argument('--lambda_prompt_align', type=float, default=0.1, help='Weight for L6: Prompt Alignment Loss (photo-sketch visual prompts)')
