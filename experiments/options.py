...
parser.add_argument('--image_adapter_m', type=float, default=0.1, help='Residual mixing ratio for image adapter output (used when --use_adapter is enabled)')
parser.add_argument('--visual_adapter_m', type=float, default=0.1, help='Alias fallback for image adapter mixing ratio')
parser.add_argument('--text_adapter_m', type=float, default=0.1, help='Residual mixing ratio for text adapter output (used when --use_adapter is enabled)')
