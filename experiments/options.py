...
parser.add_argument('--lambda_struct', type=float, default=0.0, help='Weight for structural loss L_struct (text-geometry anchored)')
parser.add_argument('--struct_warmup_epochs', type=int, default=1, help='Epochs to warm up memory bank before applying L_struct')
parser.add_argument('--struct_ema_momentum', type=float, default=0.95, help='EMA momentum for class centroids in structural memory bank')
