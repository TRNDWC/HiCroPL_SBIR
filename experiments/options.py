...
parser.add_argument('--ctx_init', type=str, default='a photo of a', help='Hard text template applied to both modalities')
...
parser.add_argument('--lambda_cross_modal', type=float, default=1.0, help='Weight for sketch-photo triplet loss')
